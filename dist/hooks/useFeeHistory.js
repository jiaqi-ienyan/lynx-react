...
export const getBlockNumber = (provider) => __awaiter(void 0, void 0, void 0, function* () {
    const cachedNumber = provider.blockNumber;
    return cachedNumber === -1 ? yield provider.getBlockNumber() : cachedNumber;
});
export const getChunksArguments = (fromBlock, toBlock, chunkSize = MAX_BLOCKS_PER_REQUEST) => {
...
export const combineHistory = (...histories) => {
...
export const trimHistory = (history, blocks) => {
...
export const getFeeHistory = (provider, fromBlock, toBlock, chunkSize) => __awaiter(void 0, void 0, void 0, function* () {
...
export const useFeeHistory = (props) => {
    var _a, _b;
