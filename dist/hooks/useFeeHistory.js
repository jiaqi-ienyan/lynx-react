...
var getChunksArguments = function (fromBlock, toBlock, chunkSize) {
    ...
    (0, tiny_invariant_1.default)(fromBlock <= toBlock, 'fromBlock should be less than or equal to toBlock');
    (0, tiny_invariant_1.default)(chunkSize > 0, 'chunkSize should be greater than 0');
...
var combineHistory = function () {
    ...
    histories.forEach(function (currentHistory, index) {
        ...
        (0, tiny_invariant_1.default)(currentHistory.oldestBlock === previousHistory.oldestBlock + previousHistory.baseFeePerGas.length - 1, 'Histories cannot be merged');
    }, []);
...
var trimHistory = function (history, blocks) {
    (0, tiny_invariant_1.default)(blocks > 0, 'blocks number should be greater than 0');
