...
export declare const getChunksArguments: <T extends [number, string, number[]]>(
  fromBlock: number,
  toBlock: number,
  chunkSize?: number
) => T[]
...
export declare const getFeeHistory: (
  provider: JsonRpcProvider,
  fromBlock: number,
  toBlock: number,
  chunkSize?: number
) => Promise<FeeHistory>
export declare const useFeeHistory: <P extends JsonRpcProvider, W extends Web3Provider>(
  props?:
    | {
        ...
        config?:
          | Partial<import('swr/dist/types').PublicConfiguration<FeeHistory, Error, import('swr').BareFetcher<any>>>
          | undefined
      }
    | undefined
