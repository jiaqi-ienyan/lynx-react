...
var defaultWrapper = function (callback) {
...
var useApprove = function (amount, token, spender, owner, wrapper) {
  ...
  var _b = (0, useMountedState_1.useMountedState)(false),
    approving = _b[0],
    setApproving = _b[1]
  var result = (0, useAllowance_1.useAllowance)(token, spender, mergedOwner)
  var _c = result.data,
    allowance = _c === void 0 ? constants_1.Zero : _c,
    initialLoading = result.initialLoading,
    updateAllowance = result.update
